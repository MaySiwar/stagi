      ...
      <div class="col-lg-8">
          ...
          <div class="blog-post-content">
            <div class="blog-post-details">
              <div class="blog-post-category">
                <a class="mb-1" href="#">Inormation</a>
              </div>
              <div class="blog-post-title">
                <h4><a href="blog-detail.html">What information is needed for an internship?</a></h4>
              </div>
              <div class="blog-post-description">
                <p class="mb-0">Organizations may require a formal application, resume, cover letter, transcripts, two or three letters of recommendation, as well as an essay on why you're interested in interning for the company or some other related question. Not all internships have the same requirements.</p>
              </div>
        ...
        <div class="blog-post text-center mt-4">
          ...
          <div class="blog-post-content">
            ...
            <div class="blog-post-footer">
              ...
              <div class="blog-post-author">
                <span>By<a href="#"><img src="images/avatar/08.jpg" alt="">John Doe</a></span>
              </div>
              <div class="blog-post-time">
        ...
        <div class="blog-post blog-post-quote mt-4 bg-primary">
          <div class="blog-post-content">
            ...
            <div class="blog-post-details text-center">
              <div class="blog-post-category">
                <a class="mb-1" href="#">Creative</a>
              </div>
              <div class="blog-post-title">
                <h5><a href="#">Blogpost With blockquote </a></h5>
              </div>
              <div class="blog-post-link justify-content-center d-flex">
                <a class="btn btn-link p-0" href="#">Continue read</a>
              </div>
            ...
            <div class="blog-post-footer text-center">
              <div class="blog-post-time">
                <a href="#"><i class="far fa-clock"></i>20 February 2020</a>
              </div>
              <div class="blog-post-author">
                <span>By<a href="#"><img src="images/avatar/02.jpg" alt="">Michael Bean</a></span>
              </div>
              <div class="blog-post-time">
        ...
        <div class="blog-post post-without-image mt-5 text-center">
          <div class="blog-post-content">
            <div class="blog-post-details">
              <div class="blog-post-category">
                <a class="mb-1" href="#">Creative</a>
              ...
              <div class="blog-post-title">
                <h4><a href="#">Expanding Access to Tech Talent</a></h4>
              </div>
              <div class="blog-post-description">
                <p class="mb-0">The first thing to remember about success is that it is a process – nothing more, nothing less. There is really no magic to it and it’s not reserved only for a select few people. As such, success really has nothing to do with luck, coincidence or fate. It really comes down to understanding the steps in the process and then executing on those steps.</p>
              </div>
              <div class="blog-post-link justify-content-center d-flex">
                <a class="btn btn-link p-0" href="#">Continue read</a>
              </div>
            ...
            <div class="blog-post-footer">
              ...
              <div class="blog-post-author">
                <span>By<a href="#"><img src="images/avatar/04.jpg" alt="">Sara Lisbon</a></span>
              </div>
              <div class="blog-post-time">
                <a href="#"><i class="far fa-comment"></i>(6)</a>
              </div>
              <div class="blog-post-share">
                <div class="share-box">
                  <a href="#"> <i class="fas fa-share-alt"></i><span class="ps-2">Share</span></a>
        ...
        <div class="blog-post blog-post-you-tube text-center mt-5">
          ...
          <div class="blog-post-content">
            <div class="blog-post-details">
              ...
              <div class="blog-post-title">
                <h4><a href="#">Blogpost with Youtube Video</a></h4>
              </div>
              <div class="blog-post-description">
                <p class="mb-0">There are basically six key areas to higher achievement. Some people will tell you there are four while others may tell you there are eight. One thing for certain though, is that irrespective of the number of steps the experts talk about, they all originate from the same roots.</p>
              </div>
              <div class="blog-post-link justify-content-center d-flex">
                <a class="btn btn-link p-0" href="#">Continue read</a>
              </div>
            ...
            <div class="blog-post-footer">
              ...
              <div class="blog-post-author">
                <span>By<a href="#"><img src="images/avatar/11.jpg" alt="">Isabelle</a></span>
              </div>
              <div class="blog-post-time">
              ...
              <div class="item">
                <div class="testimonial-item-02-small text-center">
                  ...
                  <div class="testimonial-author">
                    ...
                    <div class="testimonial-name d-flex justify-content-center">
                      <h6 class="text-primary me-2">Felica Queen</h6>
...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/jobber/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Mar 2022 19:22:18 GMT -->
</html>
