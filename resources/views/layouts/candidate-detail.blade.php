        ...
        <div class="candidate-list bg-light">
          ...
          <div class="widget ms-auto mb-0">
            <div class="company-detail-meta ms-auto">
              <a class="btn btn-primary" href="#">Download CV <i class="fas fa-download ms-1"></i></a>
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                  <div class="d-flex">
                    ...
                    <div class="feature-info-content ps-3">
                      ...
                      <span class="d-block fw-bold text-dark">Melissa Doe</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-sm-6 mb-4">
                  <div class="d-flex">
                    ...
                    <div class="feature-info-content ps-3">
                      ...
                      <span class="d-block fw-bold text-dark">(456) 478-2589</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-sm-6 mb-4">
                  <div class="d-flex">
                    ...
                    <div class="feature-info-content ps-3">
                      ...
                      <span class="d-block fw-bold text-dark">(123)-456-7890</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-sm-6 mb-4">
                  <div class="d-flex">
                    ...
                    <div class="feature-info-content ps-3">
                      ...
                      <span class="d-block fw-bold text-dark">22/08/1992</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-sm-6 mb-4">
                  <div class="d-flex">
                    ...
                    <div class="feature-info-content ps-3">
                      ...
                      <span class="d-block fw-bold text-dark">24 SL Road, London. UK</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-sm-6 mb-4">
                  <div class="d-flex">
                    ...
                    <div class="feature-info-content ps-3">
                      ...
                      <span class="d-block fw-bold text-dark">Female</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="d-flex">
                    ...
                    <div class="feature-info-content ps-3">
                      ...
                      <span class="d-block fw-bold text-dark">Melissa@website.com</span>
                    </div>
                  </div>
                </div>
              </div>
...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/jobber/candidate-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Mar 2022 19:22:52 GMT -->
</html>
